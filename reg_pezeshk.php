...
<div class="art-content-layout layout-item-1">
    ...
    <div class="art-layout-cell layout-item-2" style="width: 100%" >
		...
		<hr color="#FB0509">
		<form style="float: right;" dir="rtl" id="form1" name="form1" method="post" action="sabtp.php">
			<table width="150%">
  <tbody>
    <tr>
      <td><label style="text-align: right; font-family: 'B Mitra'; font-size: 16px;" for="textfield">کد نظام پزشکی:</label>
    <input style="text-align: right; font-family: 'B Mitra'; font-size: 16px;" type="text" name="textfield" id="textfield"></td>
      <td><label style="text-align: right; font-family: 'B Mitra'; font-size: 16px;" for="textfield2">نام و نام خانوادگی پزشک:</label>
    <input style="text-align: right; font-family: 'B Mitra'; font-size: 16px;" type="text" name="textfield2" id="textfield2"></td>
      <td><label style="text-align: right; font-family: 'B Mitra'; font-size: 16px;" for="textfield4">تلفن تماس:</label>
    <input style="text-align: right; font-family: 'B Mitra'; font-size: 16px;" type="text" name="textfield4" id="textfield3"></td>
    </tr>
    <tr>
      <td></td>
      <td> <label style="text-align: right; font-family: 'B Mitra'; font-size: 16px;" for="textfield5">آدرس:</label>
    <input style="text-align: right; font-family: 'B Mitra'; font-size: 16px;" type="text" name="textfield5" id="textfield4"></td>
      <td> <label style="text-align: right; font-family: 'B Mitra'; font-size: 16px;" for="select">تخصص:</label>
    <select style="text-align: right; font-family: 'B Mitra'; font-size: 16px;" name="select" id="select">
		...
		<option value="قلبی عروقی">قلبی عروقی</option>
		<option value="ائورولوژی">ائورولوژی</option>
		<option value="داخلی">داخلی</option>
		<option value="دندانپزشکی">دندانپزشکی</option>
		<option value="چشم و بینایی">چشم و بینایی</option>
		<option value="کلیه و مجاری ادرار">کلیه و مجاری ادرار</option>
    </select></td>
    </tr>
    <tr>
      <td>  <label style="text-align: right; font-family: 'B Mitra'; font-size: 16px;" for="select2">انتخاب بخش:</label>
    <select style="text-align: right; font-family: 'B Mitra'; font-size: 16px;" name="select2" id="select2">
		...
		<option value="سوختگی">سوختگی</option>
    </select></td>
    </tr>
  </tbody>
</table>
