...
<div class="art-content-layout layout-item-1">
    ...
    <div class="art-layout-cell layout-item-2" style="width: 100%" >
		...
		<hr>
        <p style="text-align: right; font-family: 'B Mitra'; font-size: 16px;"><span style="color: #000000;">جهت ورود به سیستم نام کاربری و کلمه عبور خود را وارد نمایید</span></p>
		<hr color="#FB0509">
		<form style="float: right;" dir="rtl" id="form1" name="form1" method="post" action="checklogin.php">
			<table width="150%">
  <tbody>
    <tr>
      <td><label style="text-align: right; font-family: 'B Mitra'; font-size: 16px;" for="textfield">نام کاربری:</label>
    <input style="text-align: right; font-family: 'B Mitra'; font-size: 16px;" type="text" name="textfield" id="textfield"></td>
      <td><label style="text-align: right; font-family: 'B Mitra'; font-size: 16px;" for="textfield2">کلمه عبور:</label>
    <input style="text-align: right; font-family: 'B Mitra'; font-size: 16px;" type="password" name="textfield2" id="textfield2"></td>
    </tr>    
  </tbody>
</table>
  <p>
    <input style="text-align: right; font-family: 'B Mitra'; background-color: #575757; font-size: 16px;" type="submit" name="submit" id="submit" value="ورود به سیستم">
    <input style="text-align: right; background-color: #000000; color: #FC0004; font-family: 'B Mitra'; font-size: 16px;" type="reset" name="reset" id="reset" value="انصراف">
  </p>
</form>
    </div>
    </div>
